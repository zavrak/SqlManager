...
using Dataplatform.SqlManager.Sessions;
using Dataplatform.SqlManager.Web.Models.Account;
using Dataplatform.SqlManager.Web.Views.Shared.Components.TenantChange;

namespace Dataplatform.SqlManager.Web.Controllers
{
    public class AccountController : SqlManagerControllerBase
    {
